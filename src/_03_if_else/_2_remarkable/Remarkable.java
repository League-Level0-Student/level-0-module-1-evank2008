...
public class Remarkable {
	public static void main(String[] args) {
		...
		name = JOptionPane.showInputDialog("Let's find out how remarkable you are! What's your name? Type 'quit' to close.");
		while(!name.equals("quit")) {
			...
			name = JOptionPane.showInputDialog("Let's find out how remarkable you are! What's your name?");
		}
	}
